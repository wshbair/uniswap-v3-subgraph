...
export class UniswapV3Staker extends ethereum.SmartContract {
  ...
  deposits(tokenId: BigInt): UniswapV3Staker__depositsResult {
    let result = super.call(
      "deposits",
  ...
  incentives(incentiveId: Bytes): UniswapV3Staker__incentivesResult {
    let result = super.call(
      "incentives",
  ...
  rewards(rewardToken: Address, owner: Address): BigInt {
...
export class GetRewardInfoCall extends ethereum.Call {
  get inputs(): GetRewardInfoCall__Inputs {
    return new GetRewardInfoCall__Inputs(this);
  }

  get outputs(): GetRewardInfoCall__Outputs {
    return new GetRewardInfoCall__Outputs(this);
  }
}

export class GetRewardInfoCall__Inputs {
  _call: GetRewardInfoCall;

  constructor(call: GetRewardInfoCall) {
    this._call = call;
  }

  get key(): GetRewardInfoCallKeyStruct {
    return changetype<GetRewardInfoCallKeyStruct>(
      this._call.inputValues[0].value.toTuple()
    );
  }
...
export class GetRewardInfoCall__Outputs {
  _call: GetRewardInfoCall;
  ...
  get secondsInsideX128(): BigInt {
    return this._call.outputValues[1].value.toBigInt();
  }
}

export class GetRewardInfoCallKeyStruct extends ethereum.Tuple {
  get rewardToken(): Address {
    return this[0].toAddress();
  }
